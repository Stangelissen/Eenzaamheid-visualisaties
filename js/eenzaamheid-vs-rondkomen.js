...
// setup x 
var xValue = function(d) { return d.Rondkomen;}, // data -> value
...
// load data
d3.csv("data/Eenzaam_vs_Rondkomen.csv", function(error, data) {

  // change string (from CSV) into number format
  data.forEach(function(d) {
    d.Rondkomen = +d.Rondkomen;
