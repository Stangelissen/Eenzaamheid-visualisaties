...
// setup x 
var xValue = function(d) { return d.Bevolking;}, // data -> value
...
// load data
d3.csv("data/Sociaal_vs_Bevolking.csv", function(error, data) {

  // change string (from CSV) into number format
  data.forEach(function(d) {
    d.Bevolking = +d.Bevolking;
    d["Eenzaamheid"] = +d["Eenzaamheid"];
 //   console.log(d);
  });

  // don't want dots overlapping axis, so add in buffer to data domain
  xScale.domain([d3.min(data, xValue)-3000, d3.max(data, xValue)+12000]);
